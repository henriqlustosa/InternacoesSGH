...
<body>
    ...
    <div class="container">
        <div class="row">
           ...
           <%-- <div class="col-2">
                <img src="imagens/logo_prefeitura.png" />
            </div>--%>
        </div>
    ...
    <script type="text/javascript">
        ...
        function dadosMes(dataIni, dataFim, tipoPesquisa) {
            ...
            $.ajax({
                async: false
                , url: '<%= ResolveUrl("http://10.48.21.64:5012/hspmsgh-api/internacoes?tipo=' + Tpesquisa + '&dt_inicio=' + dIni + '&dt_fim=' + dFim + '") %>'
                , crossDomain: true
                ...
                , success: function(data) {
                    ...
                    data.forEach(function(dt) {
                        $("tbody").append("<tr>" +
                                            ...
                                            "<td>" + dt.st_leito + "</td>" +
                                            "<td>" + CheckNullReturnBlankData(dt.dt_internacao) + "</td>" +
                                            "<td>" + CheckNullReturnBlankHora(dt.dt_internacao) + "</td>" +
                                            "<td>" + CheckNullReturnBlankData(dt.dt_entrada_setor) + "</td>" +
                                            "<td>" + CheckNullReturnBlankHora(dt.dt_entrada_setor) + "</td>" +
                                            "<td>" + dt.nm_especialidade + "</td>" +
                                            "<td>" + dt.nm_medico + "</td>" +
                                            "<td>" + CheckNullReturnBlankData(dt.dt_ultimo_evento) + "</td>" +
                                            "<td>" + CheckNullReturnBlankHora(dt.dt_ultimo_evento) + "</td>" +
                                            "<td>" + dt.nm_origem + "</td>" +
                                            "<td>" + dt.sg_cid + "</td>" +
                                            ...
                                            "<td>" + CheckNullReturnBlankData(dt.dt_alta_medica) + "</td>" +
                                            "<td>" + CheckNullReturnBlankHora(dt.dt_alta_medica) + "</td>" +
                                            "<td>" + CheckNullReturnBlankData(dt.dt_saida_paciente) + "</td>" +
                                            "<td>" + CheckNullReturnBlankHora(dt.dt_saida_paciente) + "</td>" +
        ...
        function CheckNullReturnBlankData(item) {

            item = (item == null) ? 'null' : item.substring(10, 0);
            //            alert(item); exibe o conteudo da variavel na tela

            return item;

        }
        function CheckNullReturnBlankHora(item) {

            item = (item == null) ? 'null' : item.substring(10);
